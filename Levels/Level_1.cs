...
{
    /// <summary>
    /// Manages an Level 1 Layer
    /// </summary>

    public class Level_1 : MG_abstract
    {
        ...
        {   
            ...
            shape[3] = Content.Load<Texture2D>("shape1"); //NUMER POZIOMU
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if(result1==true && result2==true && result3==true && result4==true && mouse_state.LeftButton == ButtonState.Pressed && mouse_box.Intersects(button_box[0]) && old_mouse_state.LeftButton == ButtonState.Released)
                Settings_file.CurrentState = Settings_file.Layer.Level_2;  //NEXT
        ...
        {    
            ...
            spriteBatch.DrawString(gameFont, "AND Gate Level 2",new Vector2(110,120),Color.LightGray);
