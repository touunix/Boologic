...
{   
    /// <summary>
    /// Manages an Level 6 Layer
    /// </summary>

    public class Level_6 : MG_abstract
    {
        ...
        {   
            ...
            shape[3] = Content.Load<Texture2D>("shape6"); //NUMER POZIOMU
            ...
            shape[7] = Content.Load<Texture2D>("table_not");
            shape_box[7] = new Rectangle (750, 220, shape[7].Width, shape[7].Height);
            shape[8] = Content.Load<Texture2D>("not_gate");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if(mouse_state.LeftButton == ButtonState.Pressed && mouse_box.Intersects(button_box[0]) && old_mouse_state.LeftButton == ButtonState.Released)
                Settings_file.CurrentState = Settings_file.Layer.Level_7; //NEXT
        ...
        {    
            ...
            spriteBatch.DrawString(gameFont,"NOT Gate Level",new Vector2(170,120),Color.LightGray);
            spriteBatch.DrawString(gameFont_2,"The NOT gate is a digital logic gate which implements logical negation.",new Vector2(10,220),Color.LightGray);
            spriteBatch.DrawString(gameFont_2,"In mathematical logic it is equivalent to the logical negation operator.",new Vector2(10,255),Color.LightGray);
            spriteBatch.DrawString(gameFont_2,"The behavior of operation is shown on the right, in truth table.",new Vector2(10,290),Color.LightGray);
            spriteBatch.DrawString(gameFont_2,"Symbol of NOT gate:",new Vector2(150,420),Color.LightGray);
            ...
            if(mouse_state.LeftButton == ButtonState.Pressed && mouse_box.Intersects(button_box[2]))
            {
                ...
                spriteBatch.DrawString(gameFont, "NOT Order",new Vector2(310,700),Color.Black);
            }    
        }
    }
}