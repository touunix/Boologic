...
{   
    ...
    public class Level_3 : MG_abstract
    {
        ...
        {   
            ...
            overlayer[1] = Content.Load<Texture2D>("order_silver");
            ...
            drag_element[2] = Content.Load<Texture2D>("or_gate");
            ...
            drag_element[3] = Content.Load<Texture2D>("or_gate");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if(result1==true && result2==true && result3==true && result4==true && mouse_state.LeftButton == ButtonState.Pressed && mouse_box.Intersects(button_box[0]) && old_mouse_state.LeftButton == ButtonState.Released)
                Settings_file.CurrentState = Settings_file.Layer.Level_4;  //NEXT
        ...
        {    
            ...
            spriteBatch.DrawString(gameFont, "OR Gate Level 2",new Vector2(110,120),Color.LightGray);
