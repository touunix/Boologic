...
namespace Boologic.Levels
{
    public class Level_9 : MG_abstract
    {
        ...
        {   
            ...
            shape[3] = Content.Load<Texture2D>("shape9"); //NUMER POZIOMU
            ...
            overlayer[1] = Content.Load<Texture2D>("order_emerald");
            ...
            drag_element[2] = Content.Load<Texture2D>("nand_gate");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if(result1==true && result2==true && result3==true && result4==true && mouse_state.LeftButton == ButtonState.Pressed && mouse_box.Intersects(button_box[0]) && old_mouse_state.LeftButton == ButtonState.Released)
                Settings_file.CurrentState = Settings_file.Layer.Level_10;  //NEXT
        ...
        {    
            ...
            spriteBatch.DrawString(gameFont, "NAND Gate Level 2",new Vector2(110,120),Color.LightGray);
            ...
            if(result1==true && result2==true && result3==true && result4==true && mouse_state.LeftButton == ButtonState.Pressed && mouse_box.Intersects(button_box[2]))
            {
                ...
                spriteBatch.DrawString(gameFont, "Emerald Order",new Vector2(200,700),Color.DarkGreen);
            }
        }
    }
}